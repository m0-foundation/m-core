...
contract WrappedMTokenIntegrationTests is TestUtils {
    ...
    function test_integration_yieldAccumulation() external {
        ...
        assertApproxEqAbs(yield_, accruedYield_, 2);
        ...
        assertApproxEqAbs(_wrappedMToken.totalEarningSupply(), totalEarningSupply_, 2);
        assertApproxEqAbs(_wrappedMToken.totalNonEarningSupply(), totalNonEarningSupply_, 2);
        assertApproxEqAbs(_wrappedMToken.totalSupply(), totalSupply_, 2);
        assertApproxEqAbs(_wrappedMToken.totalAccruedYield(), totalAccruedYield_, 2);
        assertApproxEqAbs(_wrappedMToken.excess(), excess_, 1);
    ...
    function test_integration_yieldTransfer() external {
        ...
        // Assert Alice (Earner)
        assertApproxEqAbs(_wrappedMToken.balanceOf(_alice), aliceBalance_, 3);
        assertEq(_wrappedMToken.accruedYieldOf(_alice), 0);
        ...
        assertEq(_wrappedMToken.totalNonEarningSupply(), totalNonEarningSupply_);
        assertApproxEqAbs(_wrappedMToken.totalSupply(), totalSupply_, 2);
        assertApproxEqAbs(_wrappedMToken.totalAccruedYield(), totalAccruedYield_, 3);
    ...
    function test_integration_yieldClaimUnwrap() external {
        ...
        assertApproxEqAbs(_wrappedMToken.balanceOf(_alice), amount_ + accruedYieldOfAlice_, 1);
        assertEq(_wrappedMToken.accruedYieldOf(_alice), 0);
        ...
        assertEq(_wrappedMToken.totalEarningSupply(), totalEarningSupply_);
        assertApproxEqAbs(_wrappedMToken.totalNonEarningSupply(), totalNonEarningSupply_, 1);
        assertApproxEqAbs(_wrappedMToken.totalSupply(), totalSupply_, 1);
        assertApproxEqAbs(_wrappedMToken.totalAccruedYield(), accruedYieldOfBob_, 3);
        assertApproxEqAbs(_wrappedMToken.excess(), excess_, 2);
        ...
        assertApproxEqAbs(_wrappedMToken.totalNonEarningSupply(), totalNonEarningSupply_, 1);
        assertApproxEqAbs(_wrappedMToken.totalSupply(), totalSupply_, 1);
        assertApproxEqAbs(_wrappedMToken.totalAccruedYield(), accruedYieldOfBob_ + accruedYieldOfCarol_, 2);
        ...
        _wrappedMToken.unwrap(_bob, bobBalance_ + accruedYieldOfBob_ - 2);

        // Assert Bob (Earner)
        assertEq(_mToken.balanceOf(_bob), bobBalance_ + accruedYieldOfBob_ - 2);
        ...
        assertApproxEqAbs(_wrappedMToken.totalNonEarningSupply(), totalNonEarningSupply_, 1);
        assertApproxEqAbs(_wrappedMToken.totalSupply(), totalSupply_, 1);
        assertApproxEqAbs(_wrappedMToken.totalAccruedYield(), accruedYieldOfCarol_, 5);
        assertApproxEqAbs(_wrappedMToken.excess(), excess_, 4);
        ...
        _wrappedMToken.unwrap(_carol, carolBalance_ + accruedYieldOfCarol_ - 2);

        // Assert Carol (Earner)
        assertEq(_mToken.balanceOf(_carol), carolBalance_ + accruedYieldOfCarol_ - 2);
        ...
        assertApproxEqAbs(_wrappedMToken.totalNonEarningSupply(), totalNonEarningSupply_, 1);
        assertApproxEqAbs(_wrappedMToken.totalSupply(), totalSupply_, 1);
        assertApproxEqAbs(_wrappedMToken.totalAccruedYield(), 0, 9);
        assertApproxEqAbs(_wrappedMToken.excess(), excess_, 4);
