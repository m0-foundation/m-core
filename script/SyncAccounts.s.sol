...
contract SyncAccounts is Script, DeployBase {
    address internal constant _POWER_TOKEN = 0x333C9430c42Ca172cCF744c139107F9FDAd0c44b; // Mainnet WETH
    ...
    function run() external {
        ...
        for (uint256 i_; i_ < _accounts.length; ++i_) {
            IPowerToken(_POWER_TOKEN).sync(_accounts[i_]);
        }
