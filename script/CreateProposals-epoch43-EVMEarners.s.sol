...
contract CreateProposals is Script, DeployBase {
    ...
    string internal constant _EARNER_MU_DESC =
        ...
        "Earner Contract relies on the ERC-1967 Proxy pattern for upgradability and the "
        "[CREATEX](https://etherscan.io/address/0xba5Ed099633D3B313e4D5F7bdc1305d3c28ba5Ed#readContract%23F4) "
        "Factory contract will be used to deploy the Earner contract via CREATE3 at the following pre-deterministic address: "
        ...
        "The Solidity code computing this guarded salt can be found "
        "[here](https://github.com/m0-foundation/m-portal/blob/ddf583b9bef971752ec1360f9b089e6fefa9c526/script/helpers/Utils.sol#L73-L100).";
